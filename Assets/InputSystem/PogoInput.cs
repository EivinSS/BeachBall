...
//     version 1.6.3
//     from Assets/InputSystem/PogoInput.inputactions
//
...
public partial class @PogoInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Centre"",
                    ""type"": ""Value"",
                    ""id"": ""ab68fa55-1576-432b-b09b-c3cc0fc611e8"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""42c8eabc-3902-43bf-a4c7-97ae9de1f8b4"",
                    ""path"": ""<Keyboard>/c"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_PogoControls_AdjustAngle = m_PogoControls.FindAction("AdjustAngle", throwIfNotFound: true);
        m_PogoControls_Jump = m_PogoControls.FindAction("Jump", throwIfNotFound: true);
        m_PogoControls_Centre = m_PogoControls.FindAction("Centre", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_PogoControls_AdjustAngle;
    private readonly InputAction m_PogoControls_Jump;
    private readonly InputAction m_PogoControls_Centre;
    public struct PogoControlsActions
    {
        private @PogoInput m_Wrapper;
        public PogoControlsActions(@PogoInput wrapper) { m_Wrapper = wrapper; }
        public InputAction @AdjustAngle => m_Wrapper.m_PogoControls_AdjustAngle;
        public InputAction @Jump => m_Wrapper.m_PogoControls_Jump;
        public InputAction @Centre => m_Wrapper.m_PogoControls_Centre;
        ...
        public void AddCallbacks(IPogoControlsActions instance)
        {
            ...
            @AdjustAngle.started += instance.OnAdjustAngle;
            @AdjustAngle.performed += instance.OnAdjustAngle;
            @AdjustAngle.canceled += instance.OnAdjustAngle;
    ...
    {
        void OnAdjustAngle(InputAction.CallbackContext context);
